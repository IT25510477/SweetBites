...
<head>
    ...
    <title>Reset Password - Sweet Bites Bakery</title>
    ...
    <div class="relative z-10 flex-grow flex items-center justify-center p-6">
        <div class="glass-panel rounded-3xl w-full max-w-4xl flex flex-col md:flex-row overflow-hidden shadow-2xl">
            ...
            <div class="md:w-1/2 relative min-h-[400px]">
                <img src="https://images.unsplash.com/photo-1517433456452-f9633a875f6f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Baking cake" class="absolute inset-0 w-full h-full object-cover rounded-l-3xl p-4">
                ...
                <div class="absolute bottom-10 left-10 right-10 text-white text-center">
                    <h2 class="text-2xl font-serif font-bold mb-2">Password Recovery</h2>
                    <p class="text-sm text-gray-200">Retrieve or reset your credentials quickly to continue ordering your favorite sweets.</p>
                </div>
            </div>
            
            <!-- Right Side Form -->
            <div class="md:w-1/2 p-10 flex flex-col justify-center text-white">
                <h2 class="text-4xl font-serif text-[#8B4513] mb-1" style="font-family: 'Playfair Display', serif;">Reset Password</h2>
                <p class="text-xs text-gray-300 mb-8 font-semibold">Enter your registered email and set a new password.</p>
                ...
                <form action="forgot-password" method="post" class="space-y-5">
                    ...
                    <div class="text-center mt-6">
                        <p class="text-sm text-gray-300">Remember your password? <a href="${pageContext.request.contextPath}/login" class="text-primary hover:text-white transition font-semibold underline underline-offset-4">Sign In</a></p>
                    </div>
                </form>
            </div>
        </div>
